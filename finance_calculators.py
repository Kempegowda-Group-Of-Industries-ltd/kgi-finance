...
app_mode = st.sidebar.selectbox("Choose the Calculator", 
                                ["Loan Calculator", "Auto Loan", "Mortgage Calculator", 
                                 "Retirement Calculator", "Interest Payment", 
                                 "Compound Interest", "Income Tax", "Investment Growth", 
                                 "Amortization", "Budget Tracker", "Inflation Calculator", 
                                 "Salary Calculator", "Sales Tax Calculator", 
...
# Call appropriate calculator functions based on user choice
if app_mode == "Loan Calculator":
    loan_calculator()
elif app_mode == "Auto Loan":
    auto_loan_calculator()
elif app_mode == "Mortgage Calculator":
    mortgage_calculator()
